...
def run():
    ...
    for x in gdp.iterrows():
        G = GDP(rank=gdp['rank'][x[0]],
                gdpPerCapita=gdp['gdpPerCapita'][x[0]])
    ...
    for x in bloodtypes.iterrows():
        B = Bloodtype(Ominus=bloodtypes['Ominus'][x[0]],
                      Oplus=bloodtypes['Oplus'][x[0]],
                      Aminus=bloodtypes['Aminus'][x[0]],
                      Aplus=bloodtypes['Aplus'][x[0]],
                      Bminus=bloodtypes['Bminus'][x[0]],
                      Bplus=bloodtypes['Bplus'][x[0]],
                      ABminus=bloodtypes['ABminus'][x[0]],
                      ABplus=bloodtypes['ABplus'][x[0]])
    ...
    for x in healthcare.iterrows():
        H = Healthcare(rank=healthcare['rank'][x[0]],
                       score=healthcare['score'][x[0]])
    ...
    for x in smoking_rate.iterrows():
        S = Smoking(male=smoking_rate['male'][x[0]],
                    female=smoking_rate['female'][x[0]],
                    total=smoking_rate['total'][x[0]])
